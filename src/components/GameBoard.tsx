          ...
          <div
            className={`mb-4 rounded-lg px-4 py-3 text-sm ${
              error
                ...
                : "border border-green-500/30 bg-green-500/10 text-green-800 dark:text-green-200"
            }`}
          >
            {error ?? message}
          </div>
          ...
          {!completed && (
            <>
              ...
              <button
                ...
                className="rounded-lg border border-ladder-orange/50 bg-ladder-orange/10 px-4 py-2 text-sm font-medium text-ladder-orange transition hover:bg-ladder-orange/20 disabled:cursor-not-allowed disabled:opacity-40"
              >
                {hintLoading
                  ? "İpucu alınıyor..."
                  : hintUsed
